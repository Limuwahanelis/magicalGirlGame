...
public class FireSpell : ContinousSpell
{
    ...
    public FireSpell(MonoBehaviour player, ParticleSystem system, List<IDamagable> damageables, PolygonCollider2D fireTrigger, Transform mainBody, float fireRange,
        float fireAngle, int attackDamage, float attackCooldown, AudioEvent fireAttackAudioEvent, AudioSource audioSource,int yinYangDamagge)
    {
    ...
    public override void Attack()
    {
        ...
        _player.StartCoroutine(DamageCor());
    }
    ...
    IEnumerator DamageCor()
    {
        ...
        _damageInfo.damageType = DamageInfo.DamageType.FIRE ;
